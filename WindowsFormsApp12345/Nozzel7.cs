...
{
    public partial class Nozzel7 : Form
    {
        public static string vehicle_no_7 = "0"; public static int slip_id;
        string nozzel_id_slip = "7";
        public Nozzel7()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@newSection", vehicle_no_7);
        ...
        {
            //Nozzel1.check_prog(e, Form1.cn7, Form1.rn7, Form1.ln7, textBox1.Text, nozzel_id_slip, slip_id);
            ...
            //e.Graphics.DrawString("Nozzel No  : 7", new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 190));
            //e.Graphics.DrawString("Vehicle No : " + textBox1.Text, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 210));
            //e.Graphics.DrawString("Liter Qty    : " + Form1.ln7, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 230));
            //e.Graphics.DrawString("Rate          : " + Form1.rn7, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 250));
            //e.Graphics.DrawString("Total cash  : " + Form1.cn7, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 270));
        ...
        private void Nozzel7_Load(object sender, EventArgs e)
        {
            vehicle_no_7 = textBox1.Text;
            print_data_noz1();
        }
