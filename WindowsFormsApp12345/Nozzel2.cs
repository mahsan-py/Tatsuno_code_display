...
{
    public partial class Nozzel2 : Form
    {

        public static int slip_id;
        public static string vehicle_no_2 = "0"; string nozzel_id_slip = "2";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@newSection", vehicle_no_2);
        ...
        {
           // Nozzel1.check_prog(e, Form1.cn2, Form1.rn2, Form1.ln2, textBox1.Text, nozzel_id_slip, slip_id);
            ...
            //e.Graphics.DrawString("ALLIED Petroleum Service ", new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(65, 70));
            ...
            //e.Graphics.DrawString("Nozzel No  : 2", new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 190));
            //e.Graphics.DrawString("Vehicle No : " + textBox1.Text, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 210));
            //e.Graphics.DrawString("Liter Qty    : " + Form1.ln2, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 230));
            //e.Graphics.DrawString("Rate          : " + Form1.rn2, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 250));
            //e.Graphics.DrawString("Total cash  : " + Form1.cn2, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 270));
        ...
        private void Nozzel2_Load(object sender, EventArgs e)
        {
            vehicle_no_2 = textBox1.Text;
            print_data_noz1();
