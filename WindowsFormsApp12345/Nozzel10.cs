...
{
    public partial class Nozzel10 : Form
    {
        ...
        public static string vehicle_no_10 = "0"; public static int slip_id; string nozzel_id_slip = "10";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@newSection", vehicle_no_10);
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            //Nozzel1.check_prog(e, Form1.cn10, Form1.rn10, Form1.ln10, textBox1.Text, nozzel_id_slip, slip_id);

            //e.Graphics.DrawString(DrawToBitmap("C:\\Users\\DELL\\Documents\\Local Machine Fuel Pump Application\\psologo.png") , new Point(50, 3));
            ...
            //e.Graphics.DrawString("Nozzel No  : 10", new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 190));
            //e.Graphics.DrawString("Vehicle No : " + textBox1.Text, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 210));
            //e.Graphics.DrawString("Liter Qty    : " + Form1.ln10, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 230));
            //e.Graphics.DrawString("Rate          : " + Form1.rn10, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 250));
            //e.Graphics.DrawString("Total cash  : " + Form1.cn10, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 270));
        ...
        private void Nozzel10_Load(object sender, EventArgs e)
        {
            vehicle_no_10 = textBox1.Text;
            print_data_noz1();
