...
{
    public partial class Nozzel5 : Form
    {
        public static string vehicle_no_5 = "0"; string nozzel_id_slip = "5";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@newSection", vehicle_no_5);
        ...
        {
           // Nozzel1.check_prog(e, Form1.cn5, Form1.rn5, Form1.ln5, textBox1.Text, nozzel_id_slip, slip_id);
            ...
            //e.Graphics.DrawString("Nozzel No  : 5", new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 190));
            //e.Graphics.DrawString("Vehicle No : " + textBox1.Text, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 210));
            //e.Graphics.DrawString("Liter Qty    : " + Form1.ln5, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 230));
            //e.Graphics.DrawString("Rate          : " + Form1.rn5, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 250));
            //e.Graphics.DrawString("Total cash  : " + Form1.cn5, new Font("Arial", 10, FontStyle.Regular), Brushes.Black, new Point(10, 270));
        ...
        private void Nozzel5_Load(object sender, EventArgs e)
        {
            vehicle_no_5 = textBox1.Text;
            print_data_noz1();
